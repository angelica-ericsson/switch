...
export const socialNodeSchema = z.object({
  ...
  data: z.object({
    text1A: z.string().nullable().optional(),
    text1B: z.string().nullable().optional(),
    text2A: z.string().nullable().optional(),
    text2B: z.string().nullable().optional(),
    text3A: z.string().nullable().optional(),
    text3B: z.string().nullable().optional(),
