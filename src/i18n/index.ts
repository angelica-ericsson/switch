    ...
    resources: {
      ...
      sv: {
        translation: {
          ...
          'AB-2_1-scene-ACT-Reaction-2nd_newsflash':
            'Du gjorde rätt i att inte beställa så många Stenmarksprodukter. Många kunder var på jakt efter ett alternativ, och du sålde helt slut på Blåställ!',
          ...
          'AB-4_4-scene-ACT-Rad-Universal_basic_income':
            'Det gick inte hela vägen den här gången. Fullmäktigeledamöterna lovade att fundera vidare på införandet av en medborgarlön, men tyckte inte att det var en bra idé just nu eftersom det skulle ta för lång tid att införa.',
          'AB-4_5-scene-ACT-Stockup_5':
          ...
          'A-newsFlash-body-ACT-Rad-Factory_closing':
            '<b>Efter ett antal turbulenta månader meddelade Stenmarks ledning igår att företaget lägger ner. Den potentielle investeraren drog sig ur i sista minuten, och en tuff ekonomisk situation, minskad produktion till följd av strejken och höga skatteskulder blev till slut för mycket för företaget.</b>\n\nDet är tyst på fabriksområdet. När stängningen meddelades runt lunchtid skickades hela personalen hem. För första gången på 148 år ekar inte längre ljuden från fabriken genom Stenmarken.\n-Det är bitterljuvt, säger Nils Wester, en före detta anställd som kommer förbi för att hämta sina saker. Å ena sidan är jag glad att företaget inte kan utsätta fler arbetare för risker, men å andra sidan är det trist att se ett företag med så lång historia gå omkull. Min pappa jobbade också här, och ett par av mina mor- och farföräldrar. Men jag är inte så ledsen över att förlora jobbet. Nästa vecka börjar jag jobba i den nyöppnade sömnadsateljén i stan med att laga och ändra kläder.',
          'B-5_1-newsFlash-body-ACT-Rad-Factory_closing':
            '<b>ÖVERSÄTT - After months of turbulence, the WildertonWear management announced yesterday that the company will be closing. The potential investor withdrew last minute, and with the tough financial situation, decreased production due to the strikes, and high costs for system upgrades, it was simply too much for the company.</b> It is a quiet day at the factory. When the closing was announced around lunchtime yesterday, the staff was sent home. After 148 years in operation, the sounds of the factory are no longer echoing through Wilderton. “It’s bittersweet,” says Niels West, a former employee who passes by to collect his things. “On the one hand, I’m glad that the factory won’t be able to put the community and climate at risk, but on the other hand, I’m sad to see a company with such a long tradition fail. My dad used to work here, and two of my grandparents. I’m not so sad about the job, though. I’m starting next week at the newly opened clothing repair and mending shop in town.”',
          'A-newsFlash-body-ACT-ModMod-Factory_closing':
            '<b>Efter flera turbulenta månader meddelade Stenmarks ledning igår att företaget lägger ner. En tuff ekonomisk situation, minskad produktion under strejken och höga skatteskulder blev till slut för mycket för företaget.</b>\n\nDet är tyst på fabriksomsrådet. När stängningen meddelades vid lunchtid igår skickades hela personalen hem. För första gången på 148 år ekar inte längre ljuden från fabriken genom Stenmarken.\n-Det är bitterljuvt, säger Nils Wester, en före detta anställd som kommer förbi för att hämta sina saker. Å ena sidan är jag glad för att företaget inte kan ustätta några fler anställda för risker, men å andra sidan är det trist att se ett företag med så lång historia gå omkull. Min pappa jobbade här, och ett par av mina mor- och farföräldrar. Men jag är inte så ledsen över att förlora jobbet. Nästa vecka börjar jag jobba på den nyöppnade sömnadsateljén i stan med att laga och ändra kläder.',
          'B-5_1-newsFlash-body-ACT-ModMod-Factory_closing':
            'After months of turbulence, the WildertonWear management announced yesterday that the company will be closing. The tough financial situation, decreased production due to the strikes, and high costs for system upgrades were simply too much for the company. It is a quiet day at the factory. When the closing was announced around lunchtime yesterday, the staff was sent home. After 148 years in operation, the sounds of the factory are no longer echoing through Wilderton. “It’s bittersweet,” says Niels West, a former employee who passes by to collect his things. “On the one hand, I’m glad that the factory won’t be able to put the community and climate at risk, but on the other hand, I’m sad to see a company with such a long tradition fail. My dad used to work here, and two of my grandparents. I’m not so sad about the job, though. I’m starting next week at the newly opened clothing repair and mending shop in town.”',
          'AB-5_2-scene-option-What_has_happened': 'Vad har hänt?',
          'AB-5_2-scene-2_yrs_later': 'Två pår senare...',
          'AB-5_3-newsFlash-HL-ACT-Mod-Centre_2_yrs': 'STENMARKSCENTRET FYLLER TVÅ ÅR',
          'AB-5_3-newsFlash-body-ACT-Mod-Centre_2_yrs':
            '<b>När maskinerna på Stenmarks stängdes ner, klev några entusiaster in. Idag firar de gamla fabriksbyggnaderna två år som mötesplats för hela samhället, och bjuder in alla ortsbor för att delta i firandet.</b>\n\nTack vare en grupp entusiaster tog Stenmarkens fabriks historia en helt ny vändning. De gamla fabriksbyggnaderna finns kvar, men istället för dånande maskiner hörs musik, konversationer och klickandet från datortangenter. Det stora hallarna har förvandlats till kontorskollektiv, med ett populärt kafé, en sömnadsateljé och ett gym. De flesta av de tidigare fabrisksarbetarna har hittat nya jobb hos skräddaren och i Blåställs verkstäder i grannstaden, eller har valt att följa sina drömmar som kaféägare eller studenter. Och ortsborna älskar sitt nya mötescenter - under de senaste månaderna har antalet besökare stadigt ökat.',
          ...
          'end-headline': 'THE END',
          'end-ACT-Rad':
            'Bra jobbat! Tack för att du spelade!\n\nTack vare dina visioner och vilda idéer, har du och dina vänner förvandlat en potentiell katastrof till en nystart för hela samhället!',
          'end-ACT-Mod':
            'Bra jobbat! Tack för att du spelade!\n\nTack vare din framsynthet och goda planering, lyckades du och dina vändner vända en potentiell katastrof till en utveckling som kommit hela samhället till del!',
          'end-ACT-ModMod/DELAY-ModMod':
