    ...
    resources: {
      ...
      sv: {
        translation: {
          ...
          'B-2_6-social-Independent_audit':
            'På Stenmarks prioriterar vi lokalbefolkningens och närmiljöns hälsa och säkerhet över allt annat. Vi har därför anlitat ett oberoende företag, Investiga, för att granska utsläpps- och avlopps-hanteringen.',
          'AB-2_7-social-Feeling_weird':
