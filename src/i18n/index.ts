    ...
    resources: {
      ...
      sv: {
        translation: {
          ...
          'AB-4_3-option-ACT/DELAY-Rad-Clothing_repair_shop':
            'Öppna en sömnadsateljé där arbetarna kan få jobb om fabriken stänger.',
          'AB-4_4-scene-DELAY-Mod-Local_sponsor':
          ...
          'AB-4_4-scene-ACT-ModMod-Clothing_repair_shop':
            'Sådärja!\n\nFörslaget om att starta en sömnadsateljé för att laga och sy om kläder gick igenom, och kommer inte bara att skapa nya jobb utan också förlänga livstiden på Stenmarks produkter.',
          'AB-4_4-scene-ACT-Mod-Evening_classes':
