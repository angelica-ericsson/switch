      ...
      en: {
        translation: {
          ...
          'AB-5_3-newsFlash-body-DELAY-Mod-Coworking_space':
            '<b>When the machines at WildertonWear stopped, many residents declared it the end of a proud history of manufacturing. But just in time for its 150th anniversary, the factory is experiencing a revival.</b>\nThe old factory buildings are still there, but instead of thundering machines, you now hear the sound of drills and saws. After some time of deliberations, the municipality has decided to turn the building into office space, with a café and small museum dedicated to the factory’s history.\nMost of the former factory workers have found work with BlueSkin or opened their own little tailoring shops, while some are still looking for new opportunities. And maybe they will one day end up in an office in the old factory building? Beth Callistor, responsible for the project, is hopeful.\n“We have already had a lot of requests from companies that are considering moving their offices here. If all goes well, this could turn into a revival of the whole community.”',
