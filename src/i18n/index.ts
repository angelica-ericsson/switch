      ...
      en: {
        translation: {
          ...
          'B-social-Super_emitter-WTF':
            'Wtf WildertonWear?! We keep buying your cheap quality products year after year to support you, and in return you continue destroying our planet?',
          "AB-social-Let's_boycott": 'That’s it, I’m boycotting WildertonWear. Who’s with me? #BoycottWW',
          'AB-scene-Stockup_1':
            'It is time to stock up on items for the coming month, and you’ll need to choose how to divide your order between the brands.\n\nGiven the likelihood of a boycott, do you buy your usual amount of WildertonWear items, or swap some for your second most popular brand, BlueSkin?',
          ...
          'B-1_2-option-ACT-No_right_to_pollute': 'A long history doesn’t give WildertonWear the right to destroy the climate.',
          ...
          'A-2_2-newsFlash-body-Ignoring_health_regulations':
            '<b>Local textile manufacturer WildertonWear has routinely disregarded health regulations, says work environment health inspector. Years of neglected safety equipment upgrades have left factory workers exposed to dangerous levels of dust and chemicals.</b>\nNone of our readers is likely to have missed the tax evasion scandal around local textile manufacturer WildertonWear lately. But the company has more dark secrets; in an exclusive interview, the Daily Times has gained information about multiple breaches of health and safety regulations.\n According to a work environment health inspector, who wishes to remain anonymous, WildertonWear has routinely ignored safety regulations about permissible levels of dust and chemicals. Safety equipment, such as air filters and industrial fans, has not been upgraded for years and currently provides insufficient protection.\nAccording to the source, WildertonWear has knowingly put its workers at risk of being affected by respiratory diseases, and as a result, there has been an increase in cancer diagnoses and respiratory diseases among employees at its factory.',
          'B-2_2-newsFlash-body-Ignoring_environmental_regulations':
            '<b>Local textile manufacturer WildertonWear has routinely disregarded environmental regulations, says environmental inspector. Years of neglected wastewater filtering system upgrades have resulted in dangerous chemicals being released in the Wilderton River.</b>\nNone of our readers is likely to have missed the emissions scandal around local textile manufacturer WildertonWear lately. But the company has more dark secrets; in an exclusive interview, the Daily Times has gained information about multiple breaches of environmental regulations.\nAccording to an environmental inspector, who wishes to remain anonymous, WildertonWear has routinely ignored environmental regulations about permissible levels of chemicals in wastewater. Wastewater filtering equipment has not been upgraded for years and currently provides insufficient protection.\nAccording to the source, WildertonWear has knowingly put the local environment and its residents at risk of being exposed to dangerous chemicals, and as a result, there has been an increase in cancer diagnoses and respiratory diseases in Wilderton.',
          ...
          'B-2_3-social-Going_on_strike':
            'From 12:00 today, 34 of our members will go on a strike. Following yesterday’s disclosure regarding WildertonWear’s environmental regulation breaches, we demand proper pollution and wastewater filtering systems so that we and our community can feel safe!',
          'AB-2_4-scene-ACT-Local_meeting_point':
            'To some residents, this is it. They really can’t support WildertonWear anymore.\n\nSupporters of the boycott come by to talk. Gradually, your shop becomes a local meeting point for those who want change, and together you discuss what to do next. What do you think should be your next step?',
          ...
          'AB-2_4-scene-WAIT-Local_meeting_point':
            'This is not good. You’ll have to consider whether or not you can still support WildertonWear.\n\nGradually, your shop becomes a local meeting point for those who want to discuss the issue, and together you discuss what to do next. What do you suggest?',
          ...
          'B-2_6-social-Independent_audit':
            'At WildertonWear, we prioritise the health of the community and our shared environment above all else. Therefore, we have hired an independent company, Investiga, to perform an audit on our pollution and wastewater management.',
          ...
          'AB-3_2-social-ACT-Think_this_through':
            'Maybe we should think this through? If the factory closes a lot of residents might have to move to find new jobs, and it could affect the entire community. Shops and restaurants might have to close. Do we want that?',
          ...
          'AB-4_1-newsFlash-DELAY-body-WW_ignored_warnings':
            '<b>A highly anticipated report, released yesterday by the auditing company Investiga, reveals that WildertonWear had been warned multiple times about the regulatory breaches without taking action.</b>\nThe discussions have been running high in the community over the past days, and are likely to continue as a result of the audit findings. But despite a widespread frustration with the company’s conduct, WildertonWear still has a lot of support in the community due to its long history.',
          ...
          'AB-4_2-social-DELAY-2_months_banner': 'If anyone is missing the “Two months of striking” banner, it is currently IN THE TRASH!',
          ...
          'AB-4_4-scene-DELAY-Mod-Local_sponsor':
            'It has taken quite some time, but you finally manage to find a local sponsor who is willing to offer WildertonWear a loan to get back on their feet. The sponsor prefers to stay anonymous and mentions that you can negotiate the repayment conditions later.\n\nYou are so relieved to finally have found a solution that you happily agree to the conditions.',
          ...
          'AB-4_4-scene-DELAY-ModMod-Attract_companies':
            'Yes, you did it! Your proposal to attract new companies was approved.\n\nA group is put together to draft a proposal with cheap land deals and potential tax reductions, and to book meetings with companies that are considering moving to Wilderton.',
          ...
          'AB-5_3-newsFlash-HL-ACT-ModMod-Community_centre_2_yrs': 'COMMUNITY CENTRE TURNS TWO YEARS',
          ...
          'AB-5_3-newsFlash-body-DELAY-Mod-Coworking_space':
            '<b>When the machines at WildertonWear stopped, many residents declared it the end of a proud history of manufacturing. But just in time for its 150th anniversary, the factory is experiencing a revival.</b>\nThe old factory buildings are still there, but instead of thundering machines, you now hear the sound of drills and saws. After some time of deliberations, the municipality has decided to turn the buildings into office space, with a café and small museum dedicated to the factory’s history.\nMost of the former factory workers have found work with BlueSkin or opened their own little tailoring shops, while some are still looking for new opportunities. And maybe they will one day end up in an office in the old factory buildings? Beth Callistor, responsible for the project, is hopeful.\n“We have already had a lot of requests from companies that are considering moving their offices here. If all goes well, this could turn into a revival of the whole community.”',
          'AB-5_3-newsFlash-HL-DELAY-ModMod-Coworking_space_opened': 'WILDERTON CO-WORKING SPACE TURNS ONE',
          'AB-5_3-newsFlash-body-DELAY-ModMod-Coworking_space_opened':
            '<b>Thanks to a group of enthusiasts, the buildings of the historical WildertonWear factory are no longer empty. Today, the old factory building celebrates one year as a modern co-working space for local entrepreneurs.</b>\nWhen the machines at WildertonWear stopped, many declared it the end of a proud history of manufacturing. But just in time for its 150th anniversary, the factory is once again thriving.\nThe factory buildings are still there, but instead of the thundering machines, you now hear soft conversations and the clicking from keyboards. Thanks to a group of enthusiasts and a generous donation by the municipality, the large halls have been turned into modern office spaces and a café.',
          ...
          'A-5_3-newsFlash-body-DELAY-Rad-Factory_revived':
            '<b>When strikes and tax problems forced the WildertonWear factory to close, many residents declared it the end of a proud history of manufacturing. But just in time for its 150th anniversary, the factory might be revived in a new shape.</b>\nThe old factory buildings are still here, but instead of thundering machines, you now hear the sound of birds echoing through the empty halls. After two years of deliberations, the municipality has finally found a large manufacturing company that is considering settling in town.\nBeth Callistor, responsible for the project, is hopeful. “We have had some very positive initial talks with the manufacturer, and we think that this could bring a lot of new jobs.”\nWhen the factory closed, many of its former workers were forced to look elsewhere for jobs. Some have been hired by BlueSkin or opened their own business, while others have left town or are still searching for a new occupation. Many shop owners and restaurants saw their revenues decrease as many residents moved out, and are also hoping that a new company could mean new business opportunities.',
        ...
        translation: {
          ...
          demographic: {
            ...
            credits: {
              headline: 'Spelmakare',
              text: 'Text: ',
              programming: 'Programmering: Matthias Feist',
            },
          },
          'AB-scene-Most_popular_brands':
          ...
          'A-1_3-social-Unfortunate_misunderstanding':
            'Det har blivit ett olyckligt missförstånd angående våra skattebetalningar. Vi kommer självklart att betala skatt, men på grund av ekonomiska svårigheter behöver vi lite mer tid.\nUnder tiden: kolla in vår nya skogshuggarkollektion!',
          'B-1_3-social-Unfortunate_misunderstanding':
            'Det har blivit ett olyckligt missförstånd angående våra växthusgasutsläpp. Vi kommer självklart att uppgradera våra filtreringssystem, men på grund av ekonomiska svårigheter behöver vi lite mer tid.\nUnder tiden: kolla in vår nya skogshuggarkollektion!',
          'A-1_4-scene-DELAY-Council_vote_extension':
          ...
          'A-2_2-newsFlash-body-Ignoring_health_regulations':
            '<b>Den lokala klädtillverkaren Stenmarks har under lång tid brutit mot arbetsmiljöregelverket, enligt en arbetsmiljöinspektör. År av försummat underhåll av säkerhetsutrustning har gjort att fabriksarbetarna har exponerats för farliga nivåer av industridamm och kemikaler.</b>\nIngen av våra läsare lär ha missat skattesmitningsskandalen kring den lokala klädtillverkaren Stenmarks under de senaste veckorna. Men företaget har fler mörka hemligheter. I en exklusiv intervju har Kvällsposten fått information om ett flertal brott mot hälso- och säkerhetsregler.\nEnligt en arbetsmiljöinspektör som vill förbli anonym har Stenmarks rutinmässigt ignorerat säkerhetsregler om tillåtna halter av industridamm och kemikalier. Säkerhetsutrustning som luftfilter och industrifläktar har inte underhållits eller bytts ut på flera år och erbjuder nu ett otillräckligt skydd. Enligt källan har Stenmarks medvetet utsatt sina arbetare för risker, och till följd av detta har antalet cancerdiagnoser och luftvägssjukdomar bland arbetare på fabriken ökat kraftigt.',
          'B-2_2-newsFlash-body-Ignoring_environmental_regulations':
            '<b>Den lokala klädtillverkaren Stenmarks har under lång tid brutit mot miljöregelverket, enligt en miljöinspektör. År av försummat underhåll av systemet för avloppsfiltrering har gjort att farliga kemikalier släppts ut i Stenmarksån.</b>\nIngen av våra läsare lär ha missat utsläppsskandalen kring den lokala textiltillverkaren Stenmarks under de senaste veckorna. Men företaget har fler mörka hemligheter. I en exklusiv intervju har Kvällsposten fått information om ett flertal brott mot miljöregelverken.\nEnligt en miljöinspektör som vill förbli anonym har Stenmarks rutinmässigt ignorerat miljöregler om högsta tillåtna kemikaliehalter i avloppsvattnet. Avloppsfiltreringssystemet har inte underhållits eller bytts ut på flera år och erbjuder nu ett otillräckligt skydd.\nEnligt källan har Stenmarks medvetet utsatt närmiljön och ortsbefolkningen för risker, och till följd av detta har antalet cancerdiagnoser och luftvägssjukdomar ökat kraftigt bland de boende i Stenmarken.',
          'A-2_3-social-Going_on_strike':
          ...
          'B-2_3-social-Going_on_strike':
            'Klockan 12 idag inleder 34 av våra medlemmar en strejk. Efter gårdagens avslöjande att Stenmarks bryter mot miljöregelverken kräver vi förbättrade utsläpps- och avloppsfiltreringssystem så att vi och alla boende i Stenmarken kan känna sig säkra!',
          'AB-2_4-scene-ACT-Local_meeting_point':
            'För en del ortsbor är det här droppen. Nu kan de inte stödja Stenmarks längre.\n\nDe som stödjer bojkotten kommer förbi för att prata. Gradvis blir din lilla butik en mötesplats för de som kräver förändring, och tillsammans diskuterar ni nästa steg. Vad tycker du att ni borde göra?',
          ...
          'B-2_6-social-Independent_audit':
            'På Stenmarks prioriterar vi lokalbefolkningens och närmiljöns hälsa över allt annat. Vi har därför anlitat ett oberoende företag, Investiga, för att granska utsläpps- och avloppshanteringen.',
          'AB-2_7-social-Feeling_weird':
          ...
          'AB-3_3-scene-WAIT-Long_term':
            'Folk är oroliga, och du inser att du måste välja sida. Borde du försöka hitta ett sätt att tvinga Stenmarks att göra de nödvändiga förändringarna utan att riskera arbetarnas jobb, eller är det dags att börja prata om hur orten kan klara sig även om fabriken tvingas stänga?\n\nVad blir ditt nästa steg?',
          'AB-3_4-scene-ACT-Rad-Community_day':
            'Framtidsspaningsdagen blev en stor framgång!\n\nEn stor grupp barnfamiljer, pensionärer, entusiastiska tonåringar och engagerade par dök upp för att drömma ihop olika visioner för framtiden.',
          'AB-3_4-scene-ACT-Mod-Suggestions':
          ...
          'A-newsFlash-body-ACT-ModMod-Factory_closing':
            '<b>Efter flera turbulenta månader meddelade Stenmarks ledning igår att företaget lägger ner. Den potentielle investeraren drog sig ur i sista minuten, och en tuff ekonomisk situation, minskad produktion under strejken och höga skatteskulder blev till slut för mycket för företaget.</b>\nDet är tyst på fabriksomsrådet. När stängningen meddelades vid lunchtid igår skickades hela personalen hem. För första gången på 148 år ekar inte längre ljuden från fabriken genom Stenmarken.\n\n- Det är bitterljuvt, säger Nils Wester, en före detta anställd som kommer förbi för att hämta sina saker. Å ena sidan är jag glad att företaget inte kan utsätta arbetarna för fler risker, men å andra sidan är det trist att se ett företag med så lång historia gå omkull. Min pappa jobbade också här, och ett par av mina mor- och farföräldrar. Men jag är inte så ledsen över att förlora jobbet. Nästa vecka börjar jag jobba med att laga och ändra kläder på den nyöppnade sömnadsateljén i stan.',
          'B-5_1-newsFlash-body-ACT-ModMod-Factory_closing':
            '<b>Efter flera turbulenta månader meddelade Stenmarks ledning igår att företaget lägger ner. Den potentielle investeraren drog sig ur i sista minuten, och en tuff ekonomisk situation, minskad produktion under strejken och höga kostnader för systemunderhåll blev till slut för mycket för företaget.</b>\nDet är tyst på fabriksområdet. När stängningen meddelades vid lunchtid igår skickades hela personalen hem. För första gången på 148 år ekar inte längre ljuden från fabriken genom Stenmarken.\n- Det är bitterljuvt, säger Nils Wester, en före detta anställd som kommer förbi för att hämta sina saker. Å ena sidan är jag glad att företaget inte kan utsätta Stenmarken och miljön för fler risker, men å andra sidan är det trist att se ett företag med så lång historia gå omkull. Min pappa jobbade också här, och ett par av mina mor- och farföräldrar. Men jag är inte så ledsen över att förlora jobbet. Nästa vecka börjar jag jobba med att laga och ändra kläder på den nyöppnade sömnadsateljén i stan.',
