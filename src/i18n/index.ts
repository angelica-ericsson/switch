    ...
    resources: {
      ...
      sv: {
        translation: {
          ...
          'B-1_2-option-ACT-No_right_to_pollute': 'Bara för att de har en lång historia har de inte rätt att förorena vår atmosfär.',
          ...
          'A-2_2-newsFlash-body-Ignoring_health_regulations':
            '<b>Enligt en arbetsmiljöinspektör har den lokala klädtillverkaren Stenmarks under lång tid brutit mot arbetsmiljöregler. År av försummat underhåll av säkerhetsutrustning har gjort att fabriksarbetarna har exponerats för farliga nivåer av industridamm och kemikaler.</b>\nIngen av våra läsare lär ha missat skattesmitningsskandalen kring den lokala klädtillverkaren Stenmarks under de senaste veckorna. Men företaget har fler mörka hemligheter. I en exklusiv intervju har Kvällsposten fått information om ett flertal brott mot hälso- och säkerhetsregler. Enligt en arbetsmiljöinspektör som vill förbli anonym har Stenmarks rutinmässigt ignorerat säkerhetsregler om tillåtna halter av industridamm och kemikalier. Säkerhetsutrustning som luftfilter och industrifläktar har inte underhållits eller bytts ut på flera år och erbjuder nu ett otillräckligt skydd. Enligt källan har Stenmarks medvetet utsatt sina arbetare för risker, och en följd av detta är att antalet cancerdiagnoser och luftvägs-sjukdomar bland arbetare på fabriken ökat kraftigt...',
          'B-2_2-newsFlash-body-Ignoring_environmental_regulations':
            '<b>Enligt en miljöinspektor har den lokala klädtillverkaren Stenmarks under lång tid brutit mot miljöregelverket. År av försummat underhåll av systemet för avloppsfiltrering har gjort att farliga kemikalier släppts ut i Stenmarksån.</b>\nIngen av våra läsare lär ha missat utsläppsskandalen kring den lokala textiltillverkaren Stenmarks under de senaste veckorna. Men företaget har fler mörka hemligheter. I en exklusiv intervju har Kvällsposten fått information om ett flertal brott mot miljöregelverken. Enligt en miljöinspektör som vill förbli anonym har Stenmarks rutinmässigt ignorerat miljöregler om högsta tillåtna kemikaliehalter i avloppsvattnet. Avloppsfiltreringssystemet har inte underhållits eller bytts ut på flera år och erbjuder nu ett otillräckligt skydd. Enligt källan har Stenmarks medvetet utsatt närmiljön och ortsbefolkningen för risker, och en följd av detta är att antalet cancerdiagnoser och luftvägssjukdomar ökat kraftigt bland de boende i Stenmarken.',
          'A-2_3-social-Going_on_strike':
          ...
          'B-2_3-social-Going_on_strike':
            'Klockan 12 idag inleder 34 av våra medlemmar en strejl. Efter gårdagens avslöjande att Stenmarks bryter mot miljöregelverken kräver vi förbättrade utsläpps- och avsloppsfiltreringssystem så att vi och alla boende i Stenmarken kan känna sig säkra!',
          'AB-2_4-scene-ACT-Local_meeting_point':
          ...
          'B-2_4-option-ACT-Organise_demonstration': 'Organisera en demonstration för att kräva bättre filtreringssysten på fabriken.',
          ...
          'B-4_1-newsFlash-body-ACT-WW-ignored_warnings':
            '<b>I en uppmärksammad rapport som släpptes igår av granskningsföretaget Investiga avslöjas att Stenmarks varnats ett flertal gånger om miljöbristerna utan att agera. Till följd av rapporten meddelade tre av landets största detaljhandelskedjor att de slutar sälja Stenmarks produkter.</b>\n-Det här är en mardröm, säger en anställd på Stenmarks som vill förbli anonym. Vi har inte gjort något fel.\nDiskussionerna har gått höga i orten under de senaste dagarna, och kommer troligen att fortsätta göra så som ett resultat av granskningsrapporten. Enligt källor har bojkotten tagit fart igen, och de strejkande arbetarna är mer beslutsamma än någonsin att fortsätta strejka tills företaget uppgraderar sina filtersystem...',
          'AB-4_1-newsFlash-DELAY-body-WW_ignored_warnings':
          ...
          'A-5_1-newsFlash-body-ACT-Mod-Factory_closing':
            '<b>Efter flera turbulenta månader meddelade Stenmarks ledning igår att företaget lägger ner. En tuff ekonomisk situation, minskad produktion till följd av strejken och höga skatteskulder blev till slut för mycket för företaget.</b>\nDet är tyst på fabriksområdet. När stängningen meddelades runt lunchtid igår skickades hela personalen hem. För första gången på 148 år ekar inte längre fabrikens ljud genom Stenmarken.\n-Det är bitterljuvt, säger Nils Wester, en före detta anställd som kommer förbi för att hämta sina saker. Å ena sidan är jag glad att företaget inte kan utsätta fler arbetare för risker, men å andra sidan är det trist att se ett företag med en så lång tradition gå under. Min pappa jobbade här, och ett par av mina mor- och farföräldrar. Men jag är inte ledsen över att ha förlorat jobbet, jag har redan anmält mig till en kvällskurs för att skola om mig  till sjuksköterska...',
          'B-5_1-newsFlash-body-ACT-Mod-Factory_closing':
            '<b>Efter flera turbulenta månader meddelade Stenmarks ledning igår att företaget lägger ner. En tuff ekonomisk situation, minskad produktion på grund av strejkerna och höga kostnader för systemunderhåll blev till slut för mycket för företaget.</b>\nDet är tyst på fabriksområdet. När stängingen meddelades runt lunchtid igår skickades hela personalen hem. För första gången på 148 år ekar inte längre fabrikens ljud genom Stenmarken.\n- Det är bitterljuvt, säger Nils Wester, en före detta anställd som kommer förbi för att hämta sina saker. Å ena sidan är jag glad att företaget inte kan utsätta fler arbetare för risker, men å andra sidan är det trist att se ett företag med så lång tradition gå under. Min pappa jobbade här, och ett par av mina mor- och farföräldrar. Men jag är inte ledsen över att ha förlorat jobbet, jag har redan anmält mig till en kvällskurs för att skola om mig till sjuksköterska...',
          'A-5_1-newsFlash-body-DELAY-ModMod-Factory_closing':
          ...
          'A-5_1-newsFlash-body-DELAY-Mod-Factory_closing':
            '<b>Efter månader av strejker och bojkotter meddelade Stenmarks ledning igår att företaget lägger ner. Efter att företaget tvingades backa från ett sponsorerbjudande som visade sig vara ett penningtvättsupplägg blev den tuffa ekonomiska situationen, minskad produktion till följd av strejkerna och höga skattekostnader till slut för mycket för företaget.</b>\nDet är tyst på fabriksområdet. När stängningen meddelades vid lunchtid igår skickades hela personalen hem. För första gången på 148 år ekar inte längre ljuden från fabriken genom Stenmarken.\n- Det är frustrerande, säger Simon Gradén, en före detta anställd som kommer förbi för att hämta sina saker. Jag fattar att folk är arga över säkerhetsbristerna, men jag är säker på att Stenmarks kunde ha löst det om de fått lite mer tid. Den här fabriken har en så lång historia - jag är fjärde generationen i min familj som jobbar här - och nedstängningen kommer att förändra hela samhället. Och jag är orolig över att inte hitta ett nytt jobb, jag kanske blir tvungen att flytta...',
          'B-5_1-newsFlash-body-DELAY-Mod-Factory_closing':
            '<b>Efter månader av strejker och bojkotter meddelade Stenmarks igår att företaget lägger ner. Efter att företaget tvingades backa från ett sponsorerbjudande som visade sig vara ett penningtvättsupplägg blev den tuffa ekonomiska situationen, minskad produktion till följd av strejkerna och höga kostnader för systemunderhåll till slut för mycket för företaget.</b>\nDet är tyst på fabriksområdet. När stängningen meddelades vid lunchtid igår skickades hela personalen hem. För första gången på 148 år ekar inte längre ljuden från fabriken genom Stenmarken.\n- Det är frustrerande, säger Simon Gradén, en före detta anställd som kommer förbi för att hämta sina saker. Jag fattar att folk är arga över miljöbristerna, men jag är säker på att Stenmarks kunde ha löst det om de fått lite mer tid. Den här fabriken har en så lång historia - jag är fjärde generationen i min familj som jobbar här - och nedstängningen komemr att förändra hela samhället. Och så är jag orolig över att hitta ett nytt jobb, jag kanske blir tvungen att flytta...',
          'A-newsFlash-body-ACT-Rad-Factory_closing':
            '<b>Efter ett antal turbulenta månader meddelade Stenmarks ledning igår att företaget lägger ner. Den potentielle investeraren drog sig ur i sista minuten, och en tuff ekonomisk situation, minskad produktion till följd av strejken och höga skatteskulder blev till slut för mycket för företaget.</b>\nDet är tyst på fabriksområdet. När stängningen meddelades runt lunchtid skickades hela personalen hem. För första gången på 148 år ekar inte längre ljuden från fabriken genom Stenmarken.\n-Det är bitterljuvt, säger Nils Wester, en före detta anställd som kommer förbi för att hämta sina saker. Å ena sidan är jag glad att företaget inte kan utsätta fler arbetare för risker, men å andra sidan är det trist att se ett företag med så lång historia gå omkull. Min pappa jobbade också här, och ett par av mina mor- och farföräldrar. Men jag är inte så ledsen över att förlora jobbet. Nästa vecka börjar jag jobba med att laga och ändra kläder på den nyöppnade sömnadsateljén i stan...',
          'B-5_1-newsFlash-body-ACT-Rad-Factory_closing':
            '<b>ÖVERSÄTT - After months of turbulence, the WildertonWear management announced yesterday that the company will be closing. The potential investor withdrew last minute, and with the tough financial situation, decreased production due to the strikes, and high costs for system upgrades, it was simply too much for the company.</b> It is a quiet day at the factory. When the closing was announced around lunchtime yesterday, the staff was sent home. After 148 years in operation, the sounds of the factory are no longer echoing through Wilderton. “It’s bittersweet,” says Niels West, a former employee who passes by to collect his things. “On the one hand, I’m glad that the factory won’t be able to put the community and climate at risk, but on the other hand, I’m sad to see a company with such a long tradition fail. My dad used to work here, and two of my grandparents. I’m not so sad about the job, though. I’m starting next week at the newly opened clothing repair and mending shop in town.”',
          'A-newsFlash-body-ACT-ModMod-Factory_closing':
            '<b>Efter flera turbulenta månader meddelade Stenmarks ledning igår att företaget lägger ner. En tuff ekonomisk situation, minskad produktion under strejken och höga skatteskulder blev till slut för mycket för företaget.</b>\nDet är tyst på fabriksomsrådet. När stängningen meddelades vid lunchtid igår skickades hela personalen hem. För första gången på 148 år ekar inte längre ljuden från fabriken genom Stenmarken.\n-Det är bitterljuvt, säger Nils Wester, en före detta anställd som kommer förbi för att hämta sina saker. Å ena sidan är jag glad att företaget inte kan ustätta några fler anställda för risker, men å andra sidan är det trist att se ett företag med så lång historia gå omkull. Min pappa jobbade här, och ett par av mina mor- och farföräldrar. Men jag är inte så ledsen över att förlora jobbet. Nästa vecka börjar jag jobba med att laga och ändra kläder på den nyöppnade sömnadsateljén i stan...',
          'B-5_1-newsFlash-body-ACT-ModMod-Factory_closing':
            'After months of turbulence, the WildertonWear management announced yesterday that the company will be closing. The tough financial situation, decreased production due to the strikes, and high costs for system upgrades were simply too much for the company. It is a quiet day at the factory. When the closing was announced around lunchtime yesterday, the staff was sent home. After 148 years in operation, the sounds of the factory are no longer echoing through Wilderton. “It’s bittersweet,” says Niels West, a former employee who passes by to collect his things. “On the one hand, I’m glad that the factory won’t be able to put the community and climate at risk, but on the other hand, I’m sad to see a company with such a long tradition fail. My dad used to work here, and two of my grandparents. I’m not so sad about the job, though. I’m starting next week at the newly opened clothing repair and mending shop in town.”',
